...
require_or_fail('jeweler', 'Jeweler (or a dependency) not available. Install it with: gem install jeweler') do
  Jeweler::Tasks.new do |gem|
    ...
    gem.add_development_dependency 'sniff'
    gem.add_dependency 'activesupport', '~>3'
    gem.add_dependency 'characterizable', '~>0.1'
    gem.add_dependency 'cohort_scope', '~>0.1'
    gem.add_dependency 'data_miner', '~>0.5' unless ENV['LOCAL_DATA_MINER']
    ...
    gem.add_dependency 'summary_judgement', '~>1.3'
